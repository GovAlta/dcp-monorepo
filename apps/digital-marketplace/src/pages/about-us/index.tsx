        ...
        <div className="container">
          <section className="goa-adm-who-we-are">
            ...
            <p>
              ...
              fostering collaboration, efficiency, and economic growth. As part
              of the Ministry of Technology and Innovation (TI), we are the
              driving force behind Alberta's digital transformation. We partner
              with ministries and stakeholders to design and develop smarter,
              better, faster digital services through user-centered design and
              agile development practices. With dozens of in-flight projects
              each year, we are committed to reducing the digital divide.
            </p>
            <p>
              ...
              skilled workforce and long-term sustainable investments in machine
              learning, artificial intelligence, and other technologies critical
              to our success and global competitiveness. Through the Digital
              Marketplace we will explore ways to enhance procurement and
              collaboration, and delivery world-class digital services that are
              easy to use, fast, efficient, and secure.
            </p>
            <p>
          ...
          <section className="goa-adm-vision">
            ...
            <p>
              ...
              processes, bid for exciting opportunities, and foster transparent
              and effective partnerships that drive impactful change and sustain
              long-term relationships.
            </p>
            <h3>Excited to learn more?</h3>
            <p>
              Our team in the Ministry of Technology and Innovation is eager to
              learn more about your services, what sets you apart, what
              motivates and inspires you, and how you can support our vision.
            </p>
            <p>
              Reach out to schedule a virtual or in-person coffee chat, explore
              opportunities to work with the Government of Alberta, and build a
              connection with us at{' '}

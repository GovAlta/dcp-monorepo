...
const AfterSigningAccordion = () => {
    return (
        ...
        <Accordion title="Receive and confirm purchase orders" content={
            <ol>
                <li><strong>Receive Purchase Orders (POs)</strong><br/>You will receive POs related to your contract via email. Review the POs carefully and confirm receipt to initiate the order fulfillment process. Click on the “<a href="https://www.alberta.ca/system/files/custom_downloaded_images/sa-quick-start-guide-for-ariba-network.pdf" target="_blank">Process Order</a>” in your PO to log in or sign up for SAP Business Network.</li>
                <li><strong>Fulfill the order</strong><br/>Begin delivering goods or services as per the contract specifications and agreed-upon timelines.</li>
            </ol>
        } />

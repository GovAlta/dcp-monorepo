  ...
  return (
    <>
      <Accordion
        ...
        content={
          <p>
            You may need to complete additional steps to finalize your supplier
            status, like submitting compliance documents or setting up payment
            details. If you aren’t already, register to the SAP Ariba/Business
            network. There is no cost to suppliers when doing business with the
            GoA in SAP Business Network in 1GX.
          </p>
        }
      />

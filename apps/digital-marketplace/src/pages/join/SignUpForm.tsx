            ...
            {success ? (
                <section id="sign-up-form" className="goa-adm-sign-up-form">
                    <section id="successDiv" className="goa-adm-form-success">
                        ...
                        <p>
                            Visit Alberta Purchasing Connection to explore
                ...
                <section id="sign-up-form" className="goa-adm-sign-up-form">
                    ...
                    <div className="goa-adm-form-container">
                        <form id="user-form">
                            <fieldset>
                                <fieldset className="goa-adm-group-radio adm-single-column">
                                    <legend>
                                        Are you a supplier or a community
                                        partner?{' '}
                                    ...
                                    <div className="goa-option">
                                        ...
                                        <label htmlFor="community-partner">
                                            Community Partner - Digitally
                                            curious Albertan, another government
                                ...
                                <div className="goa-field goa-agreement goa--required">
                                    <div className="goa-option">
                                        ...
                                        <label htmlFor="agreement">
                                            ...
                                            future engagements, surveys, and
                                            events.
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div className="goa-adm-disclaimer">
                            <p>
                                The personal information collected is for the
                                Procurement Concierge Program, Alberta Digital
                                Marketplace, an initiative of Digital Design and
                                Delivery branch, Ministry of Technology and
                                Innovation. This collection is authorized by
                                section 33 of{' '}
                                <a
                                ...
                                information, contact the Outreach Team at
                                587-990-5540, by email at{' '}
                                <a
                                ...
                                , or mail to 9942-108 Street, Edmonton, Alberta,
                                T5K 2J5.
                            </p>
                        </div>

...
export default function ApptForm() {
    ...
    const [bookings, error, isBookingsLoading] =
        useFetch<Bookings>(bookingsUrl);
    // State to track the selected contact method
    const [contactMethod, setContactMethod] = useState<ContactType | null>(
        null,
    );
            ...
            {success ? (
                <section id="sign-up-form" className="goa-adm-sign-up-form">
                    <section id="successDiv" className="goa-adm-form-success">
                        ...
                        <p>
                            We will get back to you shortly to confirm your
                            advisory meeting.
                        </p>
                            ...
                            <>
                                ...
                                <div className="goa-adm-disclaimer">
                                    <p>
                                        ...
                                        for the Supplier Outreach Program,
                                        Alberta Digital Marketplace, an
                                        initiative of Digital Design and
                                        Delivery branch, Ministry of Technology
                                        and Innovation. This collection is
                                        authorized by section 33 of{' '}
                                        <a
                                        ...
                                        . For questions about the collection of
                                        personal information, contact the
                                        Outreach Team at 587-990-5540, by email
                                        at{' '}
                                        <a
                                        ...
                                        , or mail to 9942-108 Street, Edmonton,
                                        Alberta, T5K 2J5.
                                    </p>
                                </div>

...
export default function HomePage(): JSX.Element {
    ...
    const roadmapData = (services, targetWhen) => {
        return services.filter((service) =>
            service.roadmap?.some(
                (roadmapItem) => roadmapItem.when === targetWhen,
            ),
        );
    };
    const checkedProviders =
        checkedFilters.provider === undefined
            ? []
            : Object.entries(checkedFilters.provider).filter(
                  ([, value]) => value,
              );
                    ...
                    <div className="home-sidebar no-print">
                        ...
                        <GoACheckbox
                            ...
                            description={
                                roadmapView.grouped ? (
                                    <span>
                                        Only showing roadmap items grouped by
                                        quarter.
                                    </span>
                                ) : (
                                    <span>
                                        Provides an overview showing ALL sevices
                                        and exposes roadmap items. Intended to
                                        be used with the Provider filter.
                                    </span>
                                )
                            }
                ...
                {roadmapView.grouped ? (
                    ...
                    <>
                        ...
                        <span className="last-updated">
                            Showing {services.length} of {apps.length}{' '}
                            results{' '}
                        </span>
                        <GoASpacer vSpacing="s" />

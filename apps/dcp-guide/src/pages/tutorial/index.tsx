    ...
    const renderContents = () => {
        return (
            <>
                ...
                DCP is a platform for digital content products. It includes
                shared libraries and micro-apps for rapid authoring and
                publishing of content with workflows for technical and
                non-technical writers. This monorepo uses the{' '}
                <a href="https://nx.dev/"> Nx</a> tool-stack with the{' '}
                ...
                The @nxtensions/astro extension generates projects that use
                targets matching the Astro CLI. For example, use the following
                command to to run a project in a development server:
                <GoASpacer vSpacing="l" />
                <div className="code-details" id="devDCPGuide">
                    npx nx dev dcp-guide
                </div>
                <GoASpacer vSpacing="l" />
                This aligns to the dev Astro CLI command instead of the nx
                convention serve target. Similarly the check target is included,
                instead of the lint target, for static checks.
                <GoASpacer vSpacing="l" />
                <GoAButton
                ...
                <GoASpacer vSpacing="m" />
                To generate an Astro app, use the following command, which
                utilizes a custom generator to create an Astro app starter kit
                and generate the necessary deployment files:
                <GoASpacer vSpacing="l" />
                ...
                <GoASpacer vSpacing="l" />
                After executing the command, a basic Astro app structure will be
                set up in the "app/app-title" directory. You can proceed with
                customizing and developing your Astro app based on your specific
                requirements.
                <GoASpacer vSpacing="l" />
                ...
                <GoASpacer vSpacing="m" />
                @nxtensions/astro extension includes generators for applications
                and libraries. Run the nx list command to see what is available:
                <GoASpacer vSpacing="l" />
                ...
                <GoASpacer vSpacing="m" />
                OpenShift manifests and deployments are maintained in source
                control and the pipeline automatically applies them during
                deployment stages. This is convention based and new applications
                can follow the existing files to adhere to conventions.
                Application specific manifests and supporting files are
                maintained under {'.openshift/<sub_project_name>'} with a main
                template in {'<sub_project_name>.yml'}. Apply the manifests for
                one environment to create the BuildConfig and ImageStream. For
                example:
                <GoASpacer vSpacing="l" />
                <div className="code-details" id="openshiftManifest">
                    oc login ... oc process -f
                    .openshift/dcp-guide/dcp-guide.yml -p PROJECT=dcp-dev -p
                    DEPLOY_TAG=dev | oc apply -f -
                </div>
                <GoASpacer vSpacing="l" />
                <GoAButton
                    type="secondary"
                ...
                <GoASpacer vSpacing="l" />
                Creation of resources in downstream environments is handled by
                the pipeline when promoting new builds.
                <GoASpacer vSpacing="xl" />
                <h3 className="resetSpacing" id="accessingDeployedApp">
                    Accessing the deployed app
                </h3>
                <GoASpacer vSpacing="m" />
                Upon app deployment, you can employ the provided URL structure
                to access it within specific environments. Please note that
                these URLs are exclusively accessible via an internal network.
                <GoASpacer vSpacing="l" />
                ...
                <GoASpacer vSpacing="l" />
                As an illustration, to access the "common-capabilities" app
                within the development environment, you would use the following
                URL:
                <GoASpacer vSpacing="xs" />
                <a
        ...
        return (
            <>
                <GoASideMenu>
                    ...
                    <a
                        href="#accessingDeployedApp"
                        data-testid="accessingDeployedApp"
                    >
                        Deployed app
                    </a>

...
import { GoabGrid,GoabAccordion } from '@abgov/react-components';
...
<div style="position: relative; padding-bottom:5%; padding-top:10%">
    <noscript><img src={Playbook_team_2.src} alt="" /></noscript>
    <img
      style="width:100%;height:100%"
      src={Playbook_team_2.src}
      alt=""
    />
  </div>
</GoabGrid>
    ...
    **<span style="color: var(--goa-color-brand-dark);">Typically, product teams comprise the following roles:</span>**
            <ul style="list-style-type: none">
                <li >
                    <GoabAccordion heading="Product Owner" headingSize="medium">
                ...
                <li>
                    <GoabAccordion heading="Service Designer" headingSize="medium">
                ...
                <li >
                    <GoabAccordion heading="Front End Designer" headingSize="medium">
                ...
                <li>
                    <GoabAccordion heading="Digital Architect" headingSize="medium">
                ...
                <li>
                    <GoabAccordion heading=" Full Stack Developer" headingSize="medium">
    ...
    <GoabGrid minChildWidth="30ch">
         **<span style="color: var(--goa-color-brand-dark);"><strong>Product teams also include two part time resources:</strong></span>
            <ul style="list-style-type: none">
                <li >
                    <GoabAccordion heading="Scrum Master" headingSize="medium">
                ...
                <li >
                    <GoabAccordion heading="Quality Assurance Analyst" headingSize="medium">

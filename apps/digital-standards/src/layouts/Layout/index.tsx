    ...
    return (
        <>
            ...
            {hideHero ? null : (
                ...
                >
                    <p>
                        By aligning to digital service standards, the Government
                        of Alberta sets clear expectations on how we will
                        deliver better, faster, smarter services.
                    </p>
                </GoAHeroBanner>
            )}
                        ...
                        <div>
                            <GoASideMenu>
                                <GoASideMenuGroup heading="Digital Service Standards Program">
                                    ...
                                    <a href="/service-help/">
                                        How Digital Service Standards team can
                                        help
                                    </a>
